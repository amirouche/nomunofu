...
;; Parser combinators.
;;
;; XXX: Use (nomunofu stream) because the parser combinator require a
;; somewhat functional stream to be able to backtrack.  SRFI-41 work,
;; see guile-parser-combinators, but SRFI-41 is much slower.
;;
...
;;; Code:
;;
(define-module (nomunofu combinator))

(import (scheme base))
(import (scheme charset))
(import (nomunofu stream))
...
(define (string->stream string)
  ;; TODO: optimize, avoid the read the whole string to produce a
  ;; result.
