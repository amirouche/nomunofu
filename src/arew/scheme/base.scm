...
(define-library (scheme base)
  (export
   compose const and=> sort! sort _ pk pki ;; missing in R7RS?
   ... => else
  ...
  (import (only (rnrs) _ ... => else))
  (import (except (akku-r7rs base) include))
  (import (scheme write))
  (import (only (chezscheme) include sort sort!))
  (begin
